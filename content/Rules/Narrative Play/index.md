...
|  **Result**  | **Outcome**                                                          |
| :----------: | -------------------------------------------------------------------- |
| Multiple 6's | Critical Success. As a Success, but you may also clear **1 Stress**. |
|      6       | Success                                                              |
...
### Consumables
### Essence
Essence is used as a valuable currency throughout the world. Paying for a room at a tavern, for a meal, or other minor expenses aren't paid in Essence, but whatever the local currency is in the region. In ***Realmfall***, we don't track such a currency.
