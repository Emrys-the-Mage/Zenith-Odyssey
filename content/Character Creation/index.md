...
- Your **Specialty** further narrows your area of expertise, providing additional features.
...
|           | **Themes** |           |
| :-------: | :--------: | :-------: |
| Ambition  |   Anger    | Belonging |
|   Doubt   |    Duty    |   Guilt   |
|   Hope    |  Humanity  | Identity  |
| Knowledge | Redemption | Vengeance |
### Levels
In ***Zenith Odyssey*** there are 12 "Levels", which represent how powerful your character is. A character usually starts at Level 1. At the end of each Quest, you gain a Level, which grants you new abilities and increases your statistics.
### Tier
The Levels are separated into three **Tiers**, each representing a substantial jump in power. See the table at the end of this page to check which Levels correspond to which Tiers. 
...
- Choose a **Weapon**.
- Choose 1 **Combat Talents** and 1 **Narrative Talents**.
...
- If its an odd level, choose a new **Narrative Talent**.
